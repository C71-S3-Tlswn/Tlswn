...
public class AlipayServiceImpl{
	...
	public String aliPay(HttpServletResponse response, HttpServletRequest request,String total_amoun,String subjec,String oid) throws IOException {
		  response.setContentType("text/html;charset=utf-8");
	        ...
	        aliPayRequest.setReturnUrl("http://127.0.0.1/eva?oid="+oid);
...
//毫秒数当订单号
	        ...
	        String order_number = new String(String.valueOf(li1));
	        //付款金额，从前台获取，必填
	        String total_amount = new String(total_amoun);
	        //订单名称，必填
	        String subject = new String(subjec);
